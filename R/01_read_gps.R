...
read_gps01 <- function(filepath){
  ...
  dt1 <- dt[,{
    ...
    sf::st_sfc() 
    aux_dt <- data.table(trip_id,id,departure_time,stop_id,stop_sequence,speed)[1,]
    sf::st_sf(aux_dt,geometry=geometry,crs = 4326)
  },
