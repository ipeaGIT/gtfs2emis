create_gps_outputs <- function(city_abrev, day_start, day_end){
  ...
  # city_abrev = 'ade'
  message(paste0('Working on city: ', city_abrev,', ', which(proj_cities$abrev_city == city_abrev)), ' out of ', nrow(proj_cities))
