...
# PEDRO: a conversao aqui é para simplificar? Nao esta diminuindo muito o tamanho
# alterar a unidade de medida logo aqui?
...
# PEDRO: mostrar que existe mais do que um valor, head nao esta bom
# PEDRO: converter para factor?
# object.size(EF_europe)
# 97624 bytes
# EF_europe$CO_avg <- as.factor(EF_europe$CO_avg)
# object.size(EF_europe)
# 49720 bytes
```
...
```{r}
EF_emfac <- gtfs2emis::ef_emfac(pol = "CO",
                                calendar_year = "2019",
                                ...
                                fuel = "Diesel")
head(EF_emfac)
# PEDRO: de alguma maneira mostrar os dois valores em EF_emfac
# PEDRO: converter isto para factor?
```
...
# a ser criado
data.table::setDT(poa_gpslines)[, emi_usa := poa_gpslines$dist * EF_emfac$CO_avg]

poa_gpslines[, emi_europe := poa_gpslines$dist * EF_europe$CO_avg]
# not speed-dependent
poa_gpslines[, emi_cetesb := poa_gpslines$dist * EF_cetesb]
```
