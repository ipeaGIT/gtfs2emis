...
The package `gtfs2emis` estimates hot exhaust emissions of public transport systems based on GTFS and fleet data. This vignette introduces the main functions of the package. We will use the following packages:
...
The package has two main usages that will ultimately depends on the user's
