...
```
  ...
  To estimate emissions from GTFS data, we need first to:
  
  - **compute `speed` and distance (`dist`)** of each trip between pairs of public transport stops/stations.
...
EF_europe2 <- ef_europe(pollutant = c("CO", "PM"),
                       speed = spo_gpslines$speed,
                       veh_type = total_fleet$veh_type_euro,
                       tech = "SCR",
                       euro = total_fleet$euro_stage,
