...
Alternatively, the `emis_summary()` function helps users summarize emission estimates, aggregating emissions by pollutant, time of the day, vehicle type or road segment (spatial).


## 6.1 Total emissions by pollutant type
...
```{r, eval=FALSE, message=FALSE, fig.width=5, fig.height=5}
...
mygrid_emi <- emis_grid(data = emi_list,
