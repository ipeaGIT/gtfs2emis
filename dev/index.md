...
3.  [`emis_to_dt()`](https://ipeagit.github.io/gtfs2emis/dev/reference/emis_to_dt.md)
    to convert the output of
    [`emission_model()`](https://ipeagit.github.io/gtfs2emis/dev/reference/emission_model.md)
    from `list` to `data.table`.
4.  [`emis_summary()`](https://ipeagit.github.io/gtfs2emis/dev/reference/emis_summary.md)
    to aggregate emission estimates by the time of the day, vehicle
    type, or road segment.
5.  [`emis_grid()`](https://ipeagit.github.io/gtfs2emis/dev/reference/emis_grid.md)
