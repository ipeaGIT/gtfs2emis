...
stands, the package estimates several pollutants (see table below) at high
...
formats, supporting analysis of how emission levels vary across space,
...
4. `emis_summary()` to aggregate emission estimates by the time of the day, vehicle type, or road segment.
